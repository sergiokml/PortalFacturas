...
<xsl:stylesheet version="2.0"
	...
	<xsl:output method="html"
	            indent="yes"
	            encoding="ISO-8859-1"/>
	<xsl:param name="TedTimbre"/>
	<xsl:param name="ResNum"/>
	<xsl:param name="ResYear"/>
	<xsl:variable name="FechaHora"
	              select="/sii:DTE/sii:Documento/sii:Encabezado/sii:IdDoc/sii:FchEmis|
	...
	<xsl:variable name="uppercase"
	              select="'ABCDEFGHIJKLMNOPQRSTUVWXYZÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖØÙÚÛÜÝÞ????'"/>
	<xsl:decimal-format name="cl"
	                    decimal-separator=","
	                    grouping-separator="."/>
		...
		<html>
			<head>
				...
				<style type="text/css">
					...
					#Timbre {padding: 0px 0px 10px 0px; font-family: sans-serif;	font-size:8pt; float: left;margin-left; width: 400px;	z-index:3;}

				</style>
			</head>
			<body>
				<div align="center">
					<table class="facturaDocumento"
					       border="0">
						<tr>
							<td valign="top">
								<table border="0"
												...
												<b>
													<xsl:call-template name="UPPER">
														<xsl:with-param name="text"
														                select="sii:DTE/sii:Documento/sii:Encabezado/sii:Emisor/sii:RznSoc|
															...
															<b>
																...
																<xsl:call-template name="formatearRut">
																	<xsl:with-param name="input"
																	                select="sii:DTE/sii:Documento/sii:Encabezado/sii:Emisor/sii:RUTEmisor|
																...
																<xsl:call-template name="DTEName">
																	<xsl:with-param name="codDTE"
																	                select="/sii:DTE/sii:Documento/sii:Encabezado/sii:IdDoc/sii:TipoDTE|
									...
									<tr height="65">
										<td width="43%"
											...
											<table width="100%"
												...
												<tr>
													<td width="21%"
													    class="cabeceraClientes">&#160;Se&#241;or (es)</td>
													<td style="font-family :arial;font-size:10px;text-align :left;">
														:
														<xsl:call-template name="UPPER">
															<xsl:with-param name="text"
															                select="translate(sii:DTE/sii:Documento/sii:Encabezado/sii:Receptor/sii:RznSocRecep|
												...
												<tr>
													...
													<td style="font-family :arial;font-size:10px;text-align :left;">
														...
														<xsl:call-template name="UPPER">
															<xsl:with-param name="text"
															                select="sii:DTE/sii:Documento/sii:Encabezado/sii:Receptor/sii:DirRecep|
												...
												<tr>
													...
													<td style="font-family :arial;font-size:10px;text-align :left;">
														...
														<xsl:call-template name="formatearRut">
															<xsl:with-param name="input"
															                select="sii:DTE/sii:Documento/sii:Encabezado/sii:Receptor/sii:RUTRecep|
												...
												<tr>
													...
													<td style="font-family :arial;font-size:9px;text-align :left;">
														...
														<xsl:call-template name="UPPER">
															<xsl:with-param name="text"
															                select="translate(sii:DTE/sii:Documento/sii:Encabezado/sii:Receptor/sii:GiroRecep|
										...
										<td valign="middle">
											<table width="100%"
												...
												<tr>
													<td width="20%"
													    class="cabeceraClientes">Comuna</td>
													<td colspan="1"
													    style="font-family :arial;font-size:10px;text-align :left;">
														:

														<xsl:call-template name="UPPER">
															<xsl:with-param name="text"
															                select="sii:DTE/sii:Documento/sii:Encabezado/sii:Receptor/sii:CmnaRecep|
													...
													<xsl:if test="sii:DTE/sii:Documento/sii:Encabezado/sii:Receptor/sii:CdgIntRecep|
														...
														<td width="10%"
														    class="cabeceraClientes">Cod. Cliente</td>
														<td style="font-family :arial;font-size:10px;text-align :left;">
															:
												...
												<tr>
													<td width="20%"
													    class="cabeceraClientes">Ciudad</td>
													<td colspan="1"
													    style="font-family :arial;font-size:10px;text-align :left;">
														:
														<xsl:call-template name="UPPER">
															<xsl:with-param name="text"
															                select="sii:DTE/sii:Documento/sii:Encabezado/sii:Receptor/sii:CiudadRecep|
												...
												<tr>
													<td width="20%"
													    class="cabeceraClientes">F. de Pago</td>
													<td colspan="1"
													    style="font-family :arial;font-size:10px;text-align :left;">
														:
													...
													<xsl:if test="sii:DTE/sii:Documento/sii:Encabezado/sii:Receptor/sii:Contacto|
														...
														<td width="10%"
														    class="cabeceraClientes">Contacto</td>
														<td style="font-family :arial;font-size:10px;text-align :left;">
															:
												...
												<tr>
													<td width="20%"
													    class="cabeceraClientes">Fecha Emis.</td>
													<td width="30%"
													    style="font-family :arial;font-size:10px;text-align :left;">
														:
														...
														<xsl:call-template name="format-fecha-all">
															...
															<xsl:with-param name="nombre"
															                select="'mayuscorto'"/>
															<xsl:with-param name="separador"
															                select="'  '"/>
														</xsl:call-template>
													</td>
													<td width="20%"
													    class="cabeceraClientes">Fecha Venc.</td>
													<td width="26%"
													    style="font-family :arial;font-size:10px;text-align :left;">
														:
														...
														<xsl:if test="sii:DTE/sii:Documento/sii:Encabezado/sii:IdDoc/sii:FchVenc|
															...
															<xsl:call-template name="format-fecha-all">
																<xsl:with-param name="input"
																                select="sii:DTE/sii:Documento/sii:Encabezado/sii:IdDoc/sii:FchVenc|
																								 DTE/Documento/Encabezado/IdDoc/FchVenc|
																								 sii:DTE/sii:Liquidacion/sii:Encabezado/sii:IdDoc/sii:FchVenc|
																								 DTE/Liquidacion/Encabezado/IdDoc/FchVenc|
																								 sii:DTE/sii:Exportaciones/sii:Encabezado/sii:IdDoc/sii:FchVenc|
								...
								<table width="100%"
									...
									<tr>
										<td width="20%"
										    valign="top"
										    class="cabeceraClientes2"
										    style="border-bottom:1px solid black;">Doc.Referencia</td>
										<td width="13%"
										    valign="top"
										    class="cabeceraClientes2"
										    style="border-left:1px solid black;border-bottom:1px solid black;">Folio</td>
										<td width="8%"
										    valign="top"
										    class="cabeceraClientes2"
										    style="border-left:1px solid black;border-bottom:1px solid black;">Fecha</td>
										<td width="20%"
										    valign="top"
										    class="cabeceraClientes2"
										    style="border-left:1px solid black;border-bottom:1px solid black;">Razon Ref.</td>
									</tr>
									<xsl:if test="/sii:DTE/sii:Documento/sii:Referencia|
										...
										<tr>
											...
											<td rowspan="3"
											    ...
											    valign="top"
											    height="20"
											    style="font-family:arial;font-size:7.5pt;"
											    align="left">
												<xsl:choose>
																...
																<xsl:for-each select="/sii:DTE/sii:Documento/sii:Referencia|
																	...
																	<xsl:choose>
																		...
																		<xsl:when test="sii:TpoDocRef[.='103']|TpoDocRef[.='103']">
																			LIQUIDACI&#211;N DE COMISIONISTA DISTRIBUIDOR
																			<br/>
																		</xsl:when>
																		...
																		<xsl:when test="sii:TpoDocRef[.='813']|TpoDocRef[.='813']">
																			RESOLUCI&#211;N DEL SNA SERVICIO DE EXPORTA&#211;N
																			<br/>
																		</xsl:when>
											...
											<td rowspan="3"
											    ...
											    valign="top"
											    height="20"
											    style="font-family:arial;font-size:7.5pt;border-left:1px solid black;"
											    align="center">
												<xsl:choose>
													<xsl:when test="/sii:DTE/sii:Documento/sii:Referencia|
															    /DTE/Documento/Referencia|
										...
										<td>
											...
											<table border="0"
												...
												<tr>
													...
													<td class="cabeceraClientes"
													    style="border-top:1px solid black;border-left:1px solid black;border-bottom:1px solid black;border-right:1px solid black;"
													    width="80"
													    align="center">
														<b>Total</b>
													</td>
													...
													<tr>
														<xsl:choose>
															<xsl:when test="sii:NroLinDet|NroLinDet[.!='']">
																<td class="productoTextoConMargenSIN"
														...
														<td class="productoTextoConMargenSIN"
															...
															<table>
																<tr>
																	<td class="productoTextoConMargenSin2"
																	    valign="top"
														...
														<td class="productoTextoConMargenSIN"
															...
															<xsl:if test="sii:PrcItem|PrcItem">
																<xsl:call-template name="formatea-number">
																	<xsl:with-param name="val"
																	                select="sii:PrcItem|PrcItem"/>
																	<xsl:with-param name="format-string"
																	                select="'.##0,####'"/>
														...
														<td class="productoTextoConMargenSIN"
															...
															<xsl:choose>
																<xsl:when test="sii:DescuentoMonto|DescuentoMonto[.!='']">
																	...
																	<xsl:call-template name="formatea-number">
																		<xsl:with-param name="val"
																		                select="sii:DescuentoMonto|DescuentoMonto"/>
																		<xsl:with-param name="format-string"
																		                select="'.##0'"/>
																		<xsl:with-param name="locale"
																		                select="'cl'"/>
																...
																<xsl:when test="sii:RecargoMonto|RecargoMonto[.!='']">
																	<xsl:call-template name="formatea-number">
																		<xsl:with-param name="val"
																		                select="sii:RecargoMonto|RecargoMonto"/>
																		<xsl:with-param name="format-string"
																		                select="'.##0'"/>
																		<xsl:with-param name="locale"
																		                select="'cl'"/>
														...
														<td class="productoTextoConMargenSIN"
															...
															<xsl:call-template name="formatea-number">
																<xsl:with-param name="val"
																                select="sii:MontoItem|MontoItem"/>
																<xsl:with-param name="format-string"
																                select="'.##0'"/>
																<xsl:with-param name="locale"
																                select="'cl'"/>
															...
															<tr>
																...
																<xsl:choose>
																	<xsl:when test="sii:TipoMovim|TipoMovim[.='C']">
																		<td class="productoTextoConMargenSin"
																		    style="border-left:1px solid black;"
																		    align="left"
																		    valign="top">&#160;Comisi&#243;n</td>
																	</xsl:when>
																	<xsl:otherwise>
																		<td class="productoTextoConMargenSin"
																		    style="border-left:1px solid black;"
																		    valign="top"
																		    align="left">&#160;Otros Cargos</td>
																	</xsl:otherwise>
																</xsl:choose>
																<xsl:choose>
																...
																<td class="productoTextoConMargenSin"
																	...
																	<xsl:if test="sii:TasaComision|TasaComision">
																		<xsl:call-template name="formatea-number">
																			<xsl:with-param name="val"
																			                select="sii:TasaComision|TasaComision"/>
																			<xsl:with-param name="format-string"
																			                select="'.##0,####'"/>
																			<xsl:with-param name="locale"
																			                select="'cl'"/>
																...
																<td class="productoTextoConMargenSin"
																	...
																	<xsl:if test="sii:ValComNeto|ValComNeto">
																		<xsl:call-template name="formatea-number">
																			<xsl:with-param name="val"
																			                select="sii:ValComNeto|ValComNeto"/>
																			<xsl:with-param name="format-string"
																			                select="'.##0,####'"/>
																			<xsl:with-param name="locale"
																			                select="'cl'"/>
																...
																<td class="productoTextoConMargenSin"
																	...
																	<xsl:if test="sii:ValComExe|ValComExe">
																		<xsl:call-template name="formatea-number">
																			<xsl:with-param name="val"
																			                select="sii:ValComExe|ValComExe"/>
																			<xsl:with-param name="format-string"
																			                select="'.##0,####'"/>
																			<xsl:with-param name="locale"
																			                select="'cl'"/>
																...
																<td class="productoTextoConMargenSin"
																	...
																	<xsl:if test="sii:ValComIVA|ValComIVA">
																		<xsl:call-template name="formatea-number">
																			<xsl:with-param name="val"
																			                select="sii:ValComIVA|ValComIVA"/>
																			<xsl:with-param name="format-string"
																			                select="'.##0,####'"/>
																			<xsl:with-param name="locale"
																			                select="'cl'"/>
											...
											<!--<xsl:if test="DatoAdjunto[@nombre='MontoEscrito']"><table border="0" width="100%" cellspacing="0" cellpadding="2"><tr>
                            -->
                            ...
                            <td class="productoTextoConMargenDF" style="border:1px solid black;" valign="top">
                              &#160;SON:
                              <xsl:value-of select="DatoAdjunto[@nombre='MontoEscrito']"/><br/></td></tr></table></xsl:if>-->
											<div class="espacio"/>
										</td>
									</tr>
								</table>
												...
												<td valign="top">
													<table cellpadding="0"
														...
														<tr>
															<td valign="top"
															    width="100%"
															    class="cabeceraClientes">&#160;Observaciones</td>
															<div class="espacio"/>
														</tr>
														...
														<table width="100%"
															...
															<tr>
																<td colspan="3"
																    ...
																    align="top"
																    class="cabeceraClientes2"
																    style="border-bottom:1px solid black;">Montos Totales</td>
															</tr>
															<tr>
																<!--<xsl:if test="/DatoAdjunto[@nombre='Subtotal']"><td valign="top" width="12%" class="cabeceraClientes2" style="text-align:left;">&#160;Subtotal</td><td width="2%" valign="top" class="cabeceraClientes2">$</td><td width="19%" valign="top" style="font-family:arial;font-size:9pt;" align="right"><xsl:call-template name="formatea-number"><xsl:with-param name="val" select="/DatoAdjunto[@nombre='Subtotal']"/><xsl:with-param name="format-string" select="'.##0'"/><xsl:with-param name="locale" select="'cl'"/></xsl:call-template>
                                    &#160;&#160;
                                  </td></xsl:if>-->
															</tr>
																...
																<tr>
																	<xsl:choose>
																		<xsl:when test="sii:TpoMov[.='D']|TpoMov[.='D']">
																			<td valign="top"
																			    class="cabeceraClientes2"
																			    style="text-align:left;">&#160;Descuento</td>
																			<td valign="top"
																			    class="cabeceraClientes2">$</td>
																			<td valign="top"
																		...
																		<xsl:otherwise>
																			<td valign="top"
																			    class="cabeceraClientes2"
																			    style="text-align:left;">&#160;Recargo</td>
																			<td valign="top"
																			    class="cabeceraClientes2">$</td>
																			<td valign="top"
																			    style="font-family:arial;font-size:9pt;"
															...
															<xsl:for-each select="/sii:DTE/sii:Documento/sii:Encabezado/sii:Totales|
																...
																<xsl:if test="sii:CredEC[.!='']|CredEC[.!=''] and sii:CredEC[.!='0']|CredEC[.!='0']">
																	<tr>
																		<td valign="top"
																		    class="cabeceraClientes2"
																		    style="text-align:left;">&#160;Cred. Emp. Constructoras</td>
																		<td valign="top"
																		    class="cabeceraClientes2">$</td>
																		<td valign="top"
																		    style="font-family:arial;font-size:9pt;"
																...
																<xsl:if test="sii:MntExe[.!='0'] or MntExe[.!='0'] or ../sii:IdDoc/sii:TipoDTE[.='34'] or ../IdDoc/TipoDTE[.='34']">
																	<tr>
																		<td valign="top"
																		    class="cabeceraClientes2"
																		    style="text-align:left;">&#160;Monto Exento</td>
																		<td valign="top"
																		    class="cabeceraClientes2">$</td>
																		<td valign="top"
																		    style="font-family:arial;font-size:9pt;"
																...
																<tr>
																	<td valign="top"
																	    class="cabeceraClientes2"
																	    style="text-align:left;">&#160;Monto Neto</td>
																	<td valign="top"
																	    class="cabeceraClientes2">$</td>
																	<td valign="top"
																	    style="font-family:arial;font-size:9pt;"
																...
																<tr>
																	<td valign="top"
																	    class="cabeceraClientes2"
																	    style="text-align:left;">&#160;Monto I.V.A.</td>
																	<td valign="top"
																	    class="cabeceraClientes2">$</td>
																	<td valign="top"
																	    style="font-family:arial;font-size:9pt;"
																	...
																	<xsl:choose>
																		<xsl:when test="sii:ValComExe|ValComExe[.!='']">
																			<tr>
																				<td valign="top"
																				    class="cabeceraClientes2"
																				    style="text-align:left;">&#160;Comision Exento</td>
																				<td valign="top"
																				    class="cabeceraClientes2">$</td>
																				<td valign="top"
																				    style="font-family:arial;font-size:9pt;"
																	...
																	<xsl:choose>
																		<xsl:when test="sii:ValComNeto|ValComNeto[.!='']">
																			<tr>
																				<td valign="top"
																				    class="cabeceraClientes2"
																				    style="text-align:left;">&#160;Comision Neto</td>
																				<td valign="top"
																				    class="cabeceraClientes2">$</td>
																				<td valign="top"
																				    style="font-family:arial;font-size:9pt;"
																	...
																	<xsl:choose>
																		<xsl:when test="sii:ValComIVA|ValComIVA[.!='']">
																			<tr>
																				<td valign="top"
																				    class="cabeceraClientes2"
																				    style="text-align:left;">&#160;IVA Comision 19%</td>
																				<td valign="top"
																				    class="cabeceraClientes2">$</td>
																				<td valign="top"
																				    style="font-family:arial;font-size:9pt;"
																...
																<tr>
																	<td valign="top"
																	    class="cabeceraClientes2"
																	    style="text-align:left;">&#160;Monto Total</td>
																	<td valign="top"
																	    class="cabeceraClientes2">$</td>
																	<td valign="top"
																	    style="font-family:arial;font-size:9pt;"
																...
																<xsl:if test="sii:MontoNF[.!='']|MontoNF[.!=''] and sii:MontoNF[.!='0']|MontoNF[.!='0']">
																	<tr>
																		<td valign="top"
																		    class="cabeceraClientes2"
																		    style="text-align:left;">&#160;No Facturable</td>
																		<td valign="top"
																		    class="cabeceraClientes2">$</td>
																		<td valign="top"
																		    style="font-family:arial;font-size:9pt;"
																...
																<xsl:if test="sii:MontoPeriodo[.!='']|MontoPeriodo[.!=''] and sii:MontoPeriodo[.!='0']|MontoPeriodo[.!='0']">
																	<tr>
																		<td valign="top"
																		    class="cabeceraClientes2"
																		    style="text-align:left;">&#160;Monto Per&#237;odo</td>
																		<td valign="top"
																		    class="cabeceraClientes2">$</td>
																		<td valign="top"
																		    style="font-family:arial;font-size:9pt;"
																			...
																			<xsl:call-template name="formatea-number">
																				<xsl:with-param name="val"
																				                select="sii:MontoPeriodo|MontoPeriodo"/>
																				<xsl:with-param name="format-string"
																				                select="'#.##0'"/>
																				<xsl:with-param name="locale"
																				                select="'cl'"/>
																...
																<xsl:if test="sii:SaldoAnterior[.!='']|SaldoAnterior[.!=''] and sii:SaldoAnterior[.!='0']|SaldoAnterior[.!='0']">
																	<tr>
																		<td valign="top"
																		    class="cabeceraClientes2"
																		    style="text-align:left;">&#160;Saldo Anterior</td>
																		<td valign="top"
																		    class="cabeceraClientes2">$</td>
																		<td valign="top"
																		    style="font-family:arial;font-size:9pt;"
																			...
																			<xsl:call-template name="formatea-number">
																				<xsl:with-param name="val"
																				                select="sii:SaldoAnterior|SaldoAnterior"/>
																				<xsl:with-param name="format-string"
																				                select="'#.##0'"/>
																				<xsl:with-param name="locale"
																				                select="'cl'"/>
																...
																<xsl:if test="sii:VlrPagar[.!='']|VlrPagar[.!=''] and sii:VlrPagar[.!='0']|VlrPagar[.!='0']">
																	<tr>
																		<td valign="top"
																		    class="cabeceraClientes2"
																		    style="text-align:left;">&#160;Valor a Pagar</td>
																		<td valign="top"
																		    class="cabeceraClientes2">$</td>
																		<td valign="top"
																		    style="font-family:arial;font-size:9pt;"
																...
																<table width="100%"
																	...
																	<tr>
																		<td colspan="3"
																		    ...
																		    align="top"
																		    class="cabeceraClientes2"
																		    style="border-bottom:1px solid black;">Totales en Otra Moneda</td>
																	</tr>
																		...
																		<xsl:if test="sii:MntExeOtrMnda|MntExeOtrMnda">
																			<tr>
																				...
																				<td valign="top"
																					...
																					<xsl:call-template name="formatea-number">
																						<xsl:with-param name="val"
																						                select="sii:MntExeOtrMnda|MntExeOtrMnda"/>
																						<xsl:with-param name="format-string"
																						                select="'###,##'"/>
																						<xsl:with-param name="locale"
																						                select="'cl'"/>
																		...
																		<xsl:if test="sii:MntNetoOtrMnda|MntNetoOtrMnda">
																			<tr>
																				...
																				<td valign="top"
																					...
																					<xsl:call-template name="formatea-number">
																						<xsl:with-param name="val"
																						                select="sii:MntNetoOtrMnda|MntNetoOtrMnda"/>
																						<xsl:with-param name="format-string"
																						                select="'.##0'"/>
																						<xsl:with-param name="locale"
																						                select="'cl'"/>
																		...
																		<xsl:if test="sii:IVAOtrMnda|IVAOtrMnda">
																			<tr>
																				...
																				<td valign="top"
																					...
																					<xsl:call-template name="formatea-number">
																						<xsl:with-param name="val"
																						                select="sii:IVAOtrMnda|IVAOtrMnda"/>
																						<xsl:with-param name="format-string"
																						                select="'.##0,####'"/>
																						<xsl:with-param name="locale"
																						                select="'cl'"/>
																		...
																		<xsl:if test="sii:MntTotOtrMnda|MntTotOtrMnda">
																			<tr>
																				...
																				<td valign="top"
																					...
																					<xsl:call-template name="formatea-number">
																						<xsl:with-param name="val"
																						                select="sii:MntTotOtrMnda|MntTotOtrMnda"/>
																						<xsl:with-param name="format-string"
																						                select="'#.###,##'"/>
																						<xsl:with-param name="locale"
																						                select="'cl'"/>
											...
											<xsl:choose>
												...
												<xsl:otherwise>
													...
													<font face="arial"
													      size="1">
														<br/>
														Res Nº														<xsl:value-of select="$ResNum"/>
														de														<xsl:value-of select="$ResYear"/>
	...
	<xsl:template name="UPPER">
		...
		<xsl:variable name="val"
		              select="translate($text, $smallcase, $uppercase)"/>
      ...
      2010-03-10 EPS modifica actualizando tabla de impuestos y titulos  -->
		...
		<xsl:choose>
			...
			<xsl:when test="$tipo[.='15']">
				Imp. Reten. Total Tipo:
				<xsl:value-of select="$tipo"/>
			</xsl:when>
			<xsl:when test="$tipo[.='17']">
				Imp. Adic. Fae. Carne Tipo:
				<xsl:value-of select="$tipo"/>
			</xsl:when>
			<xsl:when test="$tipo[.='18']">
				Imp. Adic. Ant. Carne Tipo:
				<xsl:value-of select="$tipo"/>
			</xsl:when>
			<xsl:when test="$tipo[.='19']">
				Imp. Adic. Ant. Harina Tipo:
				<xsl:value-of select="$tipo"/>
			</xsl:when>
			...
			<xsl:when test="$tipo[.='30']">
				Reten. Legumbres Tipo:
				<xsl:value-of select="$tipo"/>
			</xsl:when>
			<xsl:when test="$tipo[.='31']">
				Reten. Silvestres Tipo:
				<xsl:value-of select="$tipo"/>
			</xsl:when>
	...
	<xsl:template name="formatearRut">
		...
		<xsl:variable name="last"
		              select="substring($rut,string-length($rut)-2,3)"/>
		<xsl:variable name="middle"
		              select="substring($rut,string-length($rut)-5,3)"/>
	...
	<xsl:template name="formatea-number">
		...
		<xsl:variable name="result"
		              select="format-number($val, $format-string, $locale)"/>
		<xsl:choose>
	...
	<xsl:template name="DTEName">
		...
		<xsl:variable name="codDTEnum"
		              select="number($codDTE)"/>
		<xsl:choose>
